...
function OnvifServiceDevice(params) {
   ...
   this.time_diff = 0;
   this.name_space_attr_list = ['xmlns:tds="http://www.onvif.org/ver10/device/wsdl"', 'xmlns:tt="http://www.onvif.org/ver10/schema"'];
}
...
OnvifServiceDevice.prototype.getCapabilities = function (callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      mOnvifSoap
         .requestCommand(this.oxaddr, 'GetCapabilities', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.getWsdlUrl = function (callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      let soap = this._createRequestSoap(soap_body);
      mOnvifSoap
         .requestCommand(this.oxaddr, 'GetWsdlUrl', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.getDiscoveryMode = function (callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      let soap = this._createRequestSoap(soap_body);
      mOnvifSoap
         .requestCommand(this.oxaddr, 'GetDiscoveryMode', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.getScopes = function (callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      let soap = this._createRequestSoap(soap_body);
      mOnvifSoap
         .requestCommand(this.oxaddr, 'GetScopes', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.setScopes = function (params, callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      mOnvifSoap
         .requestCommand(this.oxaddr, 'SetScopes', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.addScopes = function (params, callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      mOnvifSoap
         .requestCommand(this.oxaddr, 'AddScopes', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.removeScopes = function (params, callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      mOnvifSoap
         .requestCommand(this.oxaddr, 'RemoveScopes', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.getHostname = function (callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      let soap = this._createRequestSoap(soap_body);
      mOnvifSoap
         .requestCommand(this.oxaddr, 'GetHostname', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.setHostname = function (params, callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      mOnvifSoap
         .requestCommand(this.oxaddr, 'SetHostname', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.getDNS = function (callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      let soap = this._createRequestSoap(soap_body);
      mOnvifSoap
         .requestCommand(this.oxaddr, 'GetDNS', soap)
         .then((result) => {
            try {
...
OnvifServiceDevice.prototype.setDNS = function (params, callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      mOnvifSoap
         .requestCommand(this.oxaddr, 'SetDNS', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.getNetworkInterfaces = function (callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      let soap = this._createRequestSoap(soap_body);
      mOnvifSoap
         .requestCommand(this.oxaddr, 'GetNetworkInterfaces', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.getNetworkProtocols = function (callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      let soap = this._createRequestSoap(soap_body);
      mOnvifSoap
         .requestCommand(this.oxaddr, 'GetNetworkProtocols', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.setNetworkProtocols = function (params, callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      let soap = this._createRequestSoap(soap_body);
      mOnvifSoap
         .requestCommand(this.oxaddr, 'SetNetworkProtocols', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.getNetworkDefaultGateway = function (callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      let soap = this._createRequestSoap(soap_body);
      mOnvifSoap
         .requestCommand(this.oxaddr, 'GetNetworkDefaultGateway', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.setNetworkDefaultGateway = function (params, callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      mOnvifSoap
         .requestCommand(this.oxaddr, 'SetNetworkDefaultGateway', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.getDeviceInformation = function (callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      let soap = this._createRequestSoap(soap_body);
      mOnvifSoap
         .requestCommand(this.oxaddr, 'GetDeviceInformation', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.setSystemDateAndTime = function (params, callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      mOnvifSoap
         .requestCommand(this.oxaddr, 'SetSystemDateAndTime', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.reboot = function (callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      let soap = this._createRequestSoap(soap_body);
      mOnvifSoap
         .requestCommand(this.oxaddr, 'SystemReboot', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.getUsers = function (callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      let soap = this._createRequestSoap(soap_body);
      mOnvifSoap
         .requestCommand(this.oxaddr, 'GetUsers', soap)
         .then((result) => {
            try {
...
OnvifServiceDevice.prototype.createUsers = function (params, callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      mOnvifSoap
         .requestCommand(this.oxaddr, 'CreateUsers', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.deleteUsers = function (params, callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      mOnvifSoap
         .requestCommand(this.oxaddr, 'DeleteUsers', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.setUser = function (params, callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      mOnvifSoap
         .requestCommand(this.oxaddr, 'SetUser', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.getRelayOutputs = function (callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      let soap = this._createRequestSoap(soap_body);
      mOnvifSoap
         .requestCommand(this.oxaddr, 'GetRelayOutputs', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.getNTP = function (callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      let soap = this._createRequestSoap(soap_body);
      mOnvifSoap
         .requestCommand(this.oxaddr, 'GetNTP', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.setNTP = function (params, callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      mOnvifSoap
         .requestCommand(this.oxaddr, 'SetNTP', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.getDynamicDNS = function (callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      let soap = this._createRequestSoap(soap_body);
      mOnvifSoap
         .requestCommand(this.oxaddr, 'GetDynamicDNS', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
/* ------------------------------------------------------------------
 * Method: setDynamicDNS(params[, callback])
 * - params:
 *     - Type        | String  | required | "NoUpdate" or "ClientUpdates" or "ServerUpdates"
 *   - Name      | string | optional | Name
 *   - TTL      | integer | optional | TTL
 *
 * {
 *   'Name'    : 'ddns.example.org',
 *   'TTL'    : 120,
 *   'Type'    : 'ClientUpdates',
 * }
 * ---------------------------------------------------------------- */
OnvifServiceDevice.prototype.setDynamicDNS = function (params, callback) {
   let promise = new Promise((resolve, reject) => {
      let err_msg = '';
      if ((err_msg = mOnvifSoap.isInvalidValue(params, 'object'))) {
         reject(new Error('The value of "params" was invalid: ' + err_msg));
      ...
      if ((err_msg = mOnvifSoap.isInvalidValue(params['Type'], 'string'))) {
         reject(new Error('The "Type" property was invalid: ' + err_msg));
         return;
      } else if (!type.match(/^(NoUpdate|ClientUpdates|ServerUpdates)$/)) {
         reject(new Error('The "Type" property was invalid: The value must be either  "NoUpdate" or "ClientUpdates" or "ServerUpdates"'));
         return;
      }
      ...
      if ('TTL' in params) {
         if ((err_msg = mOnvifSoap.isInvalidValue(params['TTL'], 'float'))) {
            reject(new Error('The "TTL" property was invalid: ' + err_msg));
            return;
         }
      }

      let soap_body = '';
      soap_body += '<tds:SetDynamicDNS>';
      if ('Type' in params) {
         soap_body += '<tds:Type>' + params['Type'] + '</tds:Type>';
      }
      if ('Name' in params) {
         soap_body += '<tds:Name>' + params['Name'] + '</tds:Name>';
      }
      if ('TTL' in params) {
         soap_body += '<tds:TTL>' + params['TTL'] + '</tds:TTL>';
      }
      soap_body += '</tds:SetDynamicDNS>';
      ...
      mOnvifSoap
         .requestCommand(this.oxaddr, 'SetDynamicDNS', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.getZeroConfiguration = function (callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      let soap = this._createRequestSoap(soap_body);
      mOnvifSoap
         .requestCommand(this.oxaddr, 'GetZeroConfiguration', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.getIPAddressFilter = function (callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      let soap = this._createRequestSoap(soap_body);
      mOnvifSoap
         .requestCommand(this.oxaddr, 'GetIPAddressFilter', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.setIPAddressFilter = function (params, callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      mOnvifSoap
         .requestCommand(this.oxaddr, 'SetIPAddressFilter', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.getServices = function (params, callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      mOnvifSoap
         .requestCommand(this.oxaddr, 'GetServices', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
...
OnvifServiceDevice.prototype.getServiceCapabilities = function (callback) {
   let promise = new Promise((resolve, reject) => {
      ...
      let soap = this._createRequestSoap(soap_body);
      mOnvifSoap
         .requestCommand(this.oxaddr, 'GetServiceCapabilities', soap)
         .then((result) => {
            resolve(result);
         })
         .catch((error) => {
